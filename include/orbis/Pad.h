 ...
 * -
 * This file contains objects and functions for interfacing with the
...
int32_t scePadOpenExt(int32_t userID, int32_t type, int32_t index,
                      OrbisPadExtParam *param);
...
int32_t scePadGetControllerInformation(int32_t handle,
                                       OrbisPadInformation *info);
int32_t scePadGetExtControllerInformation(int32_t handle,
                                          OrbisPadInformation *info);
int32_t scePadGetHandle(int32_t userID, uint32_t controller_type,
